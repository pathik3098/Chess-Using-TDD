...
public class QueenTest {
    ...
    public void sameAllyTest() {
        IQueen queen = new Queen(1, 1, true, "filepath", board);
    ...
    public void straightMovementTest() {
        IQueen queen = new Queen(0, 4, true, "filepath", board);
    ...
    public void diagonalMovementTest() {
        IQueen queen = new Queen(5, 5, true, "filepath", board);
